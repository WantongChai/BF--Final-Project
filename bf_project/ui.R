...
shinyUI(navbarPage(
   ...
   tabPanel(
      ...
      sidebarLayout(
         sidebarPanel(
            strong("Description"),
            p("This tab helps users view the frequencies of specific crime easily. 
              The graph generated by the user selection of the crime tells 
              which month of the year has the highest or lowest number of cases."),
